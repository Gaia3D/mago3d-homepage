...
<ul class="mobile-nav">
	...
	<li id="shortCutMenu" class="shortCuts" data-tooltip-text="<spring:message code='demo.link.menu.description'/>"><spring:message code='link'/></li>
	...
	<div id="searchMenuContent" class="searchWrap" style="margin-right: 20px;">
		<table>
			<tr style="height: 35px;">
				<td style="width: 380px;"><label for="project_id"><spring:message code='project'/></label></td>
...
<c:forEach var="project" items="${projectList}">
				...
				<li>
					...
					<button type="button" id="localSearch" class="btn" style="margin-top: 3px;"><spring:message code='search'/></button> 
				</li>
			</ul>
		</div>
		<div>
...
<c:forEach var="project" items="${projectList}">
				...
				<li>
					...
					<input type="text" id="colorObjectIds" name="colorObjectIds" placeholder=" , <spring:message code='delimiter'/>" size="15" />
				</li>
				<li>
				...
				<li>
					...
					<button type="button" id="changeColor" class="btn" style="width: 20%; margin-top: 1px;"><spring:message code='change'/></button> 
					<button type="button" id="deleteAllChangeColor" class="btn"style="width: 26%; margin-top: 1px;"><spring:message code='all.delete'/></button>
				</li>
			</ul>
		</div>
		<div>
...
<c:forEach var="project" items="${projectList}">
				...
				<li>
					...
					<button type="button" id="changeLocationAndRotation" class="btn" style="margin-top: 3px;"><spring:message code='change'/></button>
					<button type="button" id="updateLocationAndRotation" class="btn" style="margin-top: 3px;"><spring:message code='save'/></button>
				</li>
			</ul>
		</div>
		<div>
...
<c:forEach var="project" items="${projectList}">
	...
	<div id="configMenuContent" class="configWrap">
		...
		<div>
			...
			<button type="button" id="saveObjectMoveButton" class="btn" style="width: 14.1%"><spring:message code='save'/></button>
			<button type="button" id="deleteAllObjectMoveButton" class="btn" style="width: 23%; font-size: 11.5px; margin-top: 1px;"><spring:message code='all.delete'/></button>
		</div>
		<div>
			<h3><spring:message code='demo.object.occlusion.culling'/></h3>
			<div style="height: 30px;">
				<div style="display: inline-block; width: 70px;"><spring:message code='use.status'/></div>
			...
			<div style="height: 30px;">
				...
				<button type="button" id="changeOcclusionCullingButton" class="btn" style="margin-top: 3px;"><spring:message code='change'/></button>
			</div>
		</div>
		<div>
			...
			<div style="height: 30px;">
				...
				<button type="button" id="changeLodButton" class="btn" style="margin-top: 3px;"><spring:message code='change'/></button>
			</div>
		</div>
		<div>
		...
		<div>
			...
			<button type="button" id="changeSsaoRadiusButton" class="btn" style="margin-top: 3px;"><spring:message code='change'/></button>
		</div>
		<div>
